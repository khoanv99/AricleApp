...
class Config(object):
    ...
    CLIENT_SECRET = "c1527f39-9d8f-4f02-9934-dafd2dc0ceef"
    ...
    CLIENT_ID = "c840e2ad-d155-4d5a-83ea-098594f2bf1b"
    ...
    SESSION_TYPE = "filesystem"  # Token cache will be stored in server-side sessionaaaa