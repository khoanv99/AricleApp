...
class Config(object):
    ...
    CLIENT_SECRET = "816f5013-28ec-4e84-a948-fe52265ae38c"
    ...
    CLIENT_ID = "8d94e066-0ef5-4706-af5a-893c56563254"
    ...
    SESSION_TYPE = "filesystem"  # Token cache will be stored in server-side sessionaaa